...
prompt = ChatPromptTemplate.from_template(
    """You are a Kepler College registrar assistant. You should answer general questions yourself; you should be polite.
...
# Function for handling common questions
...
def vector_embedding():
    if "vectors" not in app.config:
        # Load the vector store from the saved file
        app.config['vectors'] = FAISS.load_local(
            "vector_store.faiss", 
